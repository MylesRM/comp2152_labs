...
from comp2152_labs.functions_lab05 import collect_loot
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   ...
   # print("Your belt: ", belt)
    ...
    functions_lab05.use_loot(belt, health_points)
    ...
    print("    ------------------------------------------------------------------")
    print("    |    Rolling to see who strikes first...")
   ...
   # Q1: Hero Name
    ...
    stars = "*" * num_stars
    print(f"Hero {short_name}gets <{stars}" + stars + "> stars")
